...
export const authService = {
  ...
  async registro(datos: RegistroRequest): Promise<AuthResponse> {
    try {
      ...
      console.warn(
        "Axios failed, trying fetch fallback for registro:",
        error.message,
      );
  ...
  async forgotPassword(email: string): Promise<{ message: string }> {
    try {
      ...
      console.warn(
        "Axios failed, trying fetch fallback for forgotPassword:",
        error.message,
      );
  ...
  async resetPassword(
    ...
    try {
      ...
      console.warn(
        "Axios failed, trying fetch fallback for resetPassword:",
        error.message,
      );
  ...
  async login(datos: LoginRequest): Promise<AuthResponse> {
    try {
      ...
      console.warn(
        "Axios failed or status != 200, trying fetch fallback for login:",
        error.message,
      );
  ...
  async perfil() {
    try {
      ...
      console.warn(
        "Axios failed or status != 200, trying fetch fallback for perfil:",
        error.message,
      );
...
export const publicacionesService = {
  ...
  async crearPublicacion(datos: CrearPublicacionRequest): Promise<Publicacion> {
    try {
      ...
      const response = await api.post(
        `/publicaciones?usuarioId=${perfil.id}`,
        datos,
      );
      return response.data;
    } catch (error: any) {
      console.warn(
        "Axios failed, trying fetch fallback for crearPublicacion:",
        error.message,
      );
      const perfil = await authService.perfil();
  ...
  async obtenerMisPublicaciones(): Promise<Publicacion[]> {
    try {
      ...
      const response = await api.get(
        `/publicaciones/mis-publicaciones?usuarioId=${perfil.id}`,
      );
      return response.data;
    } catch (error: any) {
      console.warn(
        "Axios failed, trying fetch fallback for obtenerMisPublicaciones:",
        error.message,
      );
      const perfil = await authService.perfil();
  ...
  async obtenerPublicaciones(
    ...
    try {
      ...
      console.warn(
        "Axios failed, trying fetch fallback for obtenerPublicaciones:",
        error.message,
      );
  ...
  async obtenerPublicacionPorId(id: string): Promise<Publicacion> {
    try {
      ...
      console.warn(
        "Axios failed, trying fetch fallback for obtenerPublicacionPorId:",
        error.message,
      );
  ...
  async buscarPublicaciones(
    ...
    const response = await api.get(
      `/publicaciones/buscar/${encodeURIComponent(termino)}?${params.toString()}`,
    );
    return response.data;
  },

  // Obtener publicaciones por categoría
  async obtenerPublicacionesPorCategoria(
    categoria: string,
    filtros: FiltrosPublicacion = {},
  ): Promise<RespuestaPublicaciones> {
    const params = new URLSearchParams();
    ...
    const response = await api.get(
      `/publicaciones/categoria/${encodeURIComponent(categoria)}?${params.toString()}`,
    );
    return response.data;
  },
  ...
  async obtenerReservasActivasDePublicacion(
    id: string,
  ...
  async verificarDisponibilidadPublicacion(
    ...
    const response = await api.get(
      `/publicaciones/${id}/disponibilidad/${encodeURIComponent(fechaInicio)}/${encodeURIComponent(fechaFin)}`,
    );
    return response.data;
  },
  ...
  async actualizarPublicacion(
    id: string,
    datos: ActualizarPublicacionRequest,
  ): Promise<Publicacion> {
    // Obtener el perfil del usuario autenticado para conseguir su ID
    const perfil = await authService.perfil();
    const response = await api.patch(
      `/publicaciones/${id}?usuarioId=${perfil.id}`,
      datos,
    );
    return response.data;
  },
...
export const reservasService = {
  ...
  async aprobarReserva(
    reservaId: string,
    datos: AprobarReservaRequest,
  ): Promise<any> {
    const response = await api.patch(
      `/usuarios/reservas/${reservaId}/aceptar`,
      datos,
    );
    return response.data;
  },
  ...
  async rechazarReserva(
    reservaId: string,
    datos: RechazarReservaRequest,
  ): Promise<any> {
    const response = await api.patch(
      `/usuarios/reservas/${reservaId}/rechazar`,
      datos,
    );
    return response.data;
  },
  ...
  async cancelarReserva(reservaId: string): Promise<any> {
    const response = await api.patch(
      `/usuarios/reservas/${reservaId}/cancelar`,
    );
    return response.data;
  },
};
