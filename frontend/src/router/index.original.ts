...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Panel de administración para listar y habilitar/deshabilitar usuarios",
      requiresAuth: true,
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Explora nuestra amplia selección de instrumentos musicales disponibles para alquiler",
    },
  },
  {
    path: "/publicacion/:id",
    ...
    meta: {
      ...
      description:
        "Información detallada del instrumento musical disponible para alquiler",
    },
  },
  {
    path: "/login",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Gestiona tus instrumentos musicales publicados y solicitudes de alquiler",
    },
  },
  {
    path: "/mis-reservas",
  ...
  },
  {
    ...
    meta: {
      ...
      description:
        "Descubre cómo funciona nuestra plataforma de alquiler de instrumentos musicales",
    },
  },
  {
    ...
    meta: {
      ...
      description:
        "Encuentra respuestas a las preguntas más comunes sobre ReSolVelo",
    },
  },
  {
    path: "/contacto",
...
router.beforeEach((to, from, next) => {
  ...
  if (to.name === "Login") {
    ...
    if (redirectParam) {
      ...
      // No guardar rutas de flujo de autenticación (previene bucles tras recuperar contraseña)
