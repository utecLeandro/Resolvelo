<template>
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-4xl mx-auto px-4">
      <h1 class="text-3xl font-bold text-gray-900 mb-8">🔧 Página de Depuración</h1>
      ...
      <div class="grid gap-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-2">
            ...
            <code class="block bg-gray-100 p-2 rounded text-sm break-all">{{ tokenInfo }}</code>
            <div class="flex gap-2">
              <button @click="obtenerToken" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                Obtener Token
              </button>
              <button @click="verificarToken" class="bg-indigo-500 text-white px-4 py-2 rounded hover:bg-indigo-600">
                Verificar Token
              </button>
            </div>
          </div>
        ...
        <!-- User Data -->
        <div class="bg-white rounded-lg shadow p-6">
          <h2 class="text-xl font-semibold mb-4">👤 Datos del Usuario (localStorage)</h2>
          <div class="space-y-2">
            <pre class="bg-gray-100 p-2 rounded text-sm">{{ userData }}</pre>
            <button @click="obtenerDatosUsuario" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-2">
            ...
            <button @click="obtenerPerfilAPI" class="bg-purple-500 text-white px-4 py-2 rounded hover:bg-purple-600">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-2">
            <pre class="bg-gray-100 p-2 rounded text-sm">{{ publicacionesUsuario }}</pre>
            <button @click="obtenerPublicacionesUsuario" class="bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-600">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-2">
            <p class="text-sm text-gray-600 mb-4">Haz login con estos usuarios para probar:</p>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          ...
          <button @click="limpiarDatos" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600">
