...
<template>
  ...
  >
    ...
    <div
      class="w-full max-w-lg md:max-w-xl mx-auto bg-white/90 backdrop-blur shadow-xl rounded-2xl border border-gray-200 p-8"
    >
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-2">
            <Switch
              ...
              :class="rememberMe ? 'bg-blue-600' : 'bg-gray-200'"
              aria-label="Recordarme"
            >
              <span
                class="inline-block h-5 w-5 transform rounded-full bg-white transition"
                :class="rememberMe ? 'translate-x-5' : 'translate-x-1'"
              />
            </Switch>
