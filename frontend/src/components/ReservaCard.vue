    ...
    <div class="p-6">
      <div class="flex items-start space-x-4">
        ...
        <div class="flex-shrink-0">
          <div
            class="w-24 h-24 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg flex items-center justify-center"
          >
            <svg
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <span class="ml-1 text-gray-900"
                  >{{ reserva.publicacion.propietario.nombre }}
                  {{ reserva.publicacion.propietario.apellido }}</span
                >
              </div>
              <div>
            ...
            <div class="flex items-center">
              ...
              <div>
                ...
                <p class="text-sm text-green-700">
                  Procede con el pago para confirmar tu reserva.
                </p>
              </div>
            </div>
          </div>
