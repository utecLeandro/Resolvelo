...
async function obtenerPublicaciones(token) {
  ...
  try {
    ...
    console.log('Publicaciones response body:', JSON.stringify(response.body, null, 2));
    ...
    if (response.statusCode === 200) {
       console.log('Keys en response.body:', Object.keys(response.body));
        ...
        console.log('Tipo de response.body.publicaciones:', typeof response.body.publicaciones);
        console.log('Es array response.body.publicaciones:', Array.isArray(response.body.publicaciones));
