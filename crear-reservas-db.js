...
async function crearReservasPrueba() {
  try {
    ...
    const usuarioReserva =
      publicacion.propietarioId === usuario1.id ? usuario2 : usuario1;

    console.log(
      `📝 Creando reservas para publicación "${publicacion.titulo}" del propietario ${publicacion.propietarioId}`,
    );
