...
async function crearPublicacionTest() {
  ...
  descripcion: 'Excelente guitarra eléctrica Fender Stratocaster en perfecto estado. Ideal para músicos profesionales y aficionados.',
  categoria: 'GUITARRAS',
  marca: 'Fender',
  modelo: 'Stratocaster',
  anioFabricacion: 2022,
  precioPorDia: 50.00,
  precioPorSemana: 300.00,
  deposito: 200.00,
  ...
  instrucciones: 'Guitarra en perfecto estado, incluye funda y cable.'
        ...
        const publicacionResponse = await axios.post(`${BASE_URL}/publicaciones`, publicacionData, {
            headers: { 
