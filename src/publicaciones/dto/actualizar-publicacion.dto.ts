...
import { IsString, IsOptional, IsDecimal, IsBoolean, IsInt, Min, Max, IsEnum, MaxLength, IsDateString, IsNumber } from 'class-validator';
...
export class ActualizarPublicacionDto {
  ...
  @IsOptional()
  @IsEnum(EstadoPublicacion, { message: 'El estado de la publicación debe ser válido' })
