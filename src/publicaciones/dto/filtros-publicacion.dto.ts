...
export class FiltrosPublicacionDto {
  ...
  @IsEnum(EstadoModeracion, {
    message: 'El estado de moderación debe ser válido',
  })
  ...
  @IsOptional()
  @IsBoolean({
    message: 'incluirTodosEstadosModeracion debe ser verdadero o falso',
  })
  @Transform(({ value }) => {
    if (value === undefined || value === null || value === '') return undefined;
    return value === 'true' || value === true;
  ...
  @IsDecimal(
    { decimal_digits: '2' },
    { message: 'La calificación mínima debe ser un decimal válido' },
  )
  @Transform(({ value }) => (value ? parseFloat(value) : undefined))
  ...
  @IsDecimal(
    { decimal_digits: '2' },
    { message: 'El radio debe ser un decimal válido' },
  )
  @Transform(({ value }) => (value ? parseFloat(value) : undefined))
