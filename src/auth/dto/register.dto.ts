 ...
 */
import { IsEmail, IsNotEmpty, MinLength, IsOptional, Matches, MaxLength } from 'class-validator';
...
export class RegisterDto {
  ...
  @EsContrasenaSegura({ message: 'La contraseña no cumple con los estándares de seguridad' })
  password!: string;
