...
let ActualizarPublicacionDto = (() => {
    ...
    return class ActualizarPublicacionDto {
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _titulo_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'El título debe ser una cadena de texto' }), (0, class_validator_1.MaxLength)(200, { message: 'El título no puede exceder 200 caracteres' })];
            _descripcion_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'La descripción debe ser una cadena de texto' })];
            ...
            _precioPorDia_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsNumber)({}, { message: 'El precio por día debe ser un número válido' }), (0, class_validator_1.Min)(0.01, { message: 'El precio por día debe ser mayor a 0' }), (0, class_transformer_1.Transform)(({ value }) => value ? parseFloat(value) : undefined)];
            ...
            _disponible_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsBoolean)({ message: 'La disponibilidad debe ser verdadero o falso' })];
            ...
            _direccion_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'La dirección debe ser una cadena de texto' }), (0, class_validator_1.MaxLength)(255, { message: 'La dirección no puede exceder 255 caracteres' })];
            _ciudad_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'La ciudad debe ser una cadena de texto' }), (0, class_validator_1.MaxLength)(100, { message: 'La ciudad no puede exceder 100 caracteres' })];
            _departamento_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'El departamento debe ser una cadena de texto' }), (0, class_validator_1.MaxLength)(100, { message: 'El departamento no puede exceder 100 caracteres' })];
            ...
            _estado_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.EstadoPublicacion, { message: 'El estado de la publicación debe ser válido' })];
            ...
            _estadoEquipo_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'El estado del equipo debe ser una cadena de texto' }), (0, class_validator_1.MaxLength)(50, { message: 'El estado del equipo no puede exceder 50 caracteres' })];
        ...
        disponible = (__runInitializers(this, _deposito_extraInitializers), __runInitializers(this, _disponible_initializers, void 0));
        diasMinimoAlquiler = (__runInitializers(this, _disponible_extraInitializers), __runInitializers(this, _diasMinimoAlquiler_initializers, void 0));
        ...
        estado = (__runInitializers(this, _longitud_extraInitializers), __runInitializers(this, _estado_initializers, void 0));
        entregaDomicilio = (__runInitializers(this, _estado_extraInitializers), __runInitializers(this, _entregaDomicilio_initializers, void 0));
