...
let ResetPasswordDto = (() => {
    ...
    return class ResetPasswordDto {
        static {
            ...
            _email_decorators = [(0, class_validator_1.IsEmail)({}, { message: 'Email inválido' })];
            _token_decorators = [(0, class_validator_1.IsString)()];
            _newPassword_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(6, { message: 'La contraseña debe tener al menos 6 caracteres' })];
        ...
        token = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _token_initializers, void 0));
