    ...
    const publicaciones = [
      {
        ...
        descripcion:
          "Guitarra acústica en excelente estado, ideal para principiantes y profesionales.",
        categoria: "GUITARRAS",
        marca: "Yamaha",
        modelo: "FG800",
        anioFabricacion: 2020,
        precioPorDia: 25.0,
        precioPorSemana: 150.0,
      ...
      },
      {
        ...
        descripcion:
          "Piano digital con 88 teclas pesadas, perfecto para práctica y presentaciones.",
        categoria: "TECLADOS",
        marca: "Casio",
        modelo: "CDP-S110",
        anioFabricacion: 2021,
        precioPorDia: 35.0,
        precioPorSemana: 200.0,
      ...
      },
      {
        ...
        descripcion:
          "Batería acústica completa con platillos, ideal para ensayos y grabaciones.",
        categoria: "BATERIAS",
        marca: "Pearl",
        modelo: "Export Series",
        anioFabricacion: 2019,
        precioPorDia: 45.0,
        precioPorSemana: 280.0,
    ...
    for (let i = 0; i < publicaciones.length; i++) {
      ...
      try {
        ...
        if (response.statusCode === 201 || response.statusCode === 200) {
          console.log(
            `   ✅ Creada exitosamente (ID: ${response.body.data?.id || "N/A"})`,
          );
        } else {
          console.log(
            `   ❌ Error al crear (${response.statusCode}): ${response.body.message || "Error desconocido"}`,
          );
        }
      } catch (error) {
