    ...
    try {
        ...
        if (response.data.length > 0) {
            ...
            response.data.forEach((pub, index) => {
                console.log(`${index + 1}. ${pub.titulo} - ${pub.estado} - $${pub.precioPorDia}/día`);
                console.log(`   📍 ${pub.direccion}, ${pub.ciudad}, ${pub.departamento}`);
                console.log(`   👤 Usuario: ${pub.usuario.nombre} ${pub.usuario.apellido}`);
                console.log('');
            });
        } else {
