...
async function listarPublicacionesAdmin(token, incluirTodosEstadosModeracion = true) {
  try {
    const params = {};
    if (incluirTodosEstadosModeracion) params.incluirTodosEstadosModeracion = true;
    ...
    console.log('Error al listar publicaciones admin:', error.response?.data || error.message);
    return null;
  }
}

async function main() {
  console.log('🔍 Listando publicaciones de administración (Todos los estados de moderación)...\n');
