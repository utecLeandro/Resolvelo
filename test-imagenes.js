...
async function obtenerPublicaciones() {
  try {
    ...
    if (response.data && response.data.publicaciones && Array.isArray(response.data.publicaciones)) {
      console.log('Publicaciones encontradas:', response.data.publicaciones.length);
